...
public final class Constants
{
    ...
    public static class MotionControl
    {
        ...
        public static final PIDConstants INTAKE_EXTEND_PID = new PIDConstants(0.0, 0.0, 0.0); //CHANGE PID LATER
    ...
    public static class DriveSettings
    {
        ...
        public static double JOYSTICK_THROTTLE_X_EXPONENT = 2;
        public static double JOYSTICK_THROTTLE_Y_EXPONENT = 2;
